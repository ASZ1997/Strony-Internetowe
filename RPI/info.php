...
<script type="text/javascript">var galTable= new Array(); var galx = 0;</script><script type="text/javascript">function simplecookienotification_v01_create_cookie(name,value,days) { if (days) { var date = new Date(); date.setTime(date.getTime()+(days*24*60*60*1000)); var expires = "; expires="+date.toGMTString(); } else var expires = ""; document.cookie = name+"="+value+expires+"; path=/"; document.getElementById("simplecookienotification_v01").style.display = "none"; } function simplecookienotification_v01_read_cookie(name) { var nameEQ = name + "="; var ca = document.cookie.split(";"); for(var i=0;i < ca.length;i++) { var c = ca[i]; while (c.charAt(0)==" ") c = c.substring(1,c.length); if (c.indexOf(nameEQ) == 0) return c.substring(nameEQ.length,c.length); }return null;}var simplecookienotification_v01_jest = simplecookienotification_v01_read_cookie("simplecookienotification_v01");if(simplecookienotification_v01_jest==1){ document.getElementById("simplecookienotification_v01").style.display = "none"; }</script>
   ...
   <div class="kolumna_srodkowa">
                        ...
                        <div class="panel_tresc">
                                        <p class="naglowek_srodkowy">O Sprzęcie</p>
 Do zlealizowania projektu, użyte zostały:
 <ul>
...
<b> Raspberry Pi</b>
<br></br>
Platforma komputerowa stworzona przez Raspberry Pi Foundation.	

<img src="obrazy/RASP_03_01.png" width="300" height="150" ALIGN="RIGHT">
      
Na pokładzie Raspbery Pi 3B+ znajduje się procesor Broadcom BCM2837, wyposażony w cztery 64-bitowe rdzenie Cortex-A53.
1GN pamięci RAM. Moduł Bluetooth oraz WiFi(płytka dopiero od modelu 3B posiada te moduły), oraz 4 wejścia USB 2.0.
Na płytce znajduje się uniwersalne złącze rozszerzeń, do którego podpina się dodatkowe nakładki (HATy) lub pojedyncze elementy elektroniczne. 
<br></br>
<img src="obrazy/opis.jpg" width="650" height="450">
<br><br></br></br>
<b>Sense Hat</b>
<br></br>
Moduł rozszerzający dedykowany do komputerów Raspberry Pi 2/B+, Raspberry Pi 3.

Raspberry Pi Sense HAT umieszcza się na górze płytki Raspberry Pi za pomocą 40-pinowego złącza GPIO (którym przesyłane są dane oraz dostarczane zasilanie).
Sense HAT ma zintegrowany układ wyposażony w czujniki, który można wykorzystać do wielu projektów (eksperymenty, aplikacje, gry).

Czujniki mierzą orientację w przestrzeni (dzięki akcelerometrowi, żyroskopowi 3D oraz magnetometrowi), ciśnienie, wilgotność powietrza, 
temperaturę otoczenia. Matryca LED wyświetla dane uzyskane z pracy poszczególnych czujników. Może być także wykorzystana do wyświetlania prostych gier typu Tetris.
<img src="obrazy/RPI_SENSE_HAT_1.png" width="300" height="150" ALIGN="RIGHT">
<br></br>
<b>Sense Hat zawiera:</b>
<li>3-osiowy żyroskop</li>
<li>akcelerometr</li>
<li>magnetometr</li>
<li>czujnik ciśnienia</li>
<li>czujnik temperatury</li>
<li>czujnik wilgotności</li>
<li>matrycowy wyświetlacz LED 8x8</li>
<li>mały joystick z przyciskiem</li>
<br></br>
<b>Specyfikacja:</b>
<li>Zasilanie: z pinów Rasberry Pi</li>
<li>Zgodne z Rasberry Pi 3, 2, B+, A+</li>
<li>Żyroskop - czujnik prędkości kątowej: ±245/500/2000dps</li>
<li>Akcelerometr - czujnik przyspieszenia liniowego: ±-2/4/8/16 g</li>
<li>Magnetometr - czujnik magnetyczny: ± 4/8/12/16 gausów</li>
<li>Czujnik ciśnienia: skala absolutna 260 - 1260 hPa</li>
<li>Czujnik temperatury: do ± 2 st. C w skali 0-65 st. C</li>
<li>Czujnik wilgotności względnej</li>
<li>Matrycowy wyświetlacz LED RGB 8x8</li>
<li>Mały 5-przyciskowy joystick</li>
<br></br>
<img src="obrazy/opissh.jpg" width="650" height="450">
<br><br></br></br>	  
