...
<body>
<body onLoad="czas()">
<div id="naglowek_CTP"><a href="/moj/index.php"><p>Poradnik Marvel Future Fight</p></a></div>
<div id="witaj">
<?php
...
?>	
	...
	<div class="kolumna_srodkowa">
			...
			<div class="panel_tresc">
					<p class="naglowek_srodkowy">C.T.P. of Refirement</p>
					<img src="obrazy/jajko.jpg" ALIGN="LEFT" width="150" height="200" />
					<p class="tresc">
Jedno z 9 dostępnych CTP w grze. Polecane głównie dla postaci defensywnych, oraz leczacych się. <br>
<br>
CTP of Refinement można je zdobyc z paczki obelisków dostępnej w sklepie gry za kryształki. Można je również wygrać w trybie "Legendary Battle" za wzmocnienie stroju Hulka Raganarok, oraz Shuri przy zakupie trybu Extreme Black Panther na range mythinc. Od niedawna jest minimalna szansa na zdobycie go w trybie Giant Boss Raid.<br><br> Jednakże CTP Refinement jest najmniej popularne, ponieważ nie ma statystyk, które zwiększaja obrażenia od ataku.
<br><br>
Statystyki CTP o Refinement:<br>
<br>
<li>Max HP ^ +x%(max: 34%)<br></li>
<li>Recovery Rate ^ +x%(max: 90%)<br></li>
<li>Activation Rate: when HP is below 50%<br></li>
Applies: Self<br>
Guards against x(4~6) hits.(6 Sec.)<br>
x%(max: 20%) recorvery of Max HP.<br>
<li>Cooldown Time 15 seconds.<br></li>
					</p>
