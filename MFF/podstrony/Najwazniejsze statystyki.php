...
<body>
<body onLoad="czas()">
	<div id="naglowek_STATS"><a href="/moj/index.php"><p>Poradnik Marvel Future Fight</p></a></div>
		<div id="witaj">
<?php
...
?>	
	...
	<div class="kolumna_srodkowa">
			...
			<div class="panel_tresc">
					<p class="naglowek_srodkowy">Karty-Najważniejsze statystyki</p>
					<p class="tresc"> maksymalne wartosci cech postaci</p>
					<img src="obrazy/statystyki.jpg" width="400" height="400">
