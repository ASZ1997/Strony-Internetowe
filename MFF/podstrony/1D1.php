...
<body>
<body onLoad="czas()">
	<div id="naglowek_D"><a href="/moj/index.php"><p>Poradnik Marvel Future Fight</p></a></div>
		<div id="witaj">
<?php
...
?>	
	...
	<div class="kolumna_srodkowa">
			...
			<div class="panel_tresc">
					<p class="naglowek_srodkowy">Dzień1:Blast SuperVillain</p>
					<p class="tresc">
<b>Magneto (gramy Magneto) / Cyclops (uni) / Ulysses Klaue ALBO Stryfe</b><br>
<p style="text-indent: 10%; ">Bez Magneto na t3 i jego uni, to nawet nie ma podejscia (chyba że nie mamy
też Stryfe). Jeżeli jednak posiadamy, jest w stanie smiało walnac ponad milion
punktów. Jego rotacja jest w zasadzie dosyć prosta.<br>
5c4c2 (obel) 3c5c4c2 (obel) 3c5c4c2c6 (obel)</p><br><br>
<b>Magneto / Stryfe / Cyclops (uni)</b><br>
Stryfe jest BAAAAARDZO długo robionym bohaterem, choćby przez to, że
musimy robić Collosusa, a pewnie wiele osób nie ma go zrobionego na t2.
Jeżeli jednak posiadamy Stryfe, albo tak jak wyżej wspomniałam, Magneto nie
jest zmaksowany, to nim również można milion walnać.<br>
2c4c3(obel) 4c5 i od nowa.<br>
Ewentualnie ale to tak TOTALNIE ewentualnie w chwili w której nie mamy W
OGÓLE Magneto i Stryfe to:<bR>
<b>Cyclops (uni) ALBO Lash / Ulysses / nie wiem, Modok. </b><br>
Ulysses też cos tam jest w stanie ugrać. Jakies tam 200k będzie, ale rotacja na
niego jest taka bezsensowna, że pozwolą ja sobie zignorować. Tu każdy musi
grać na wyczucie, to bardzo dobra postać, ale stanowczo za wolna na abx.
					</p>
