...
<body>
<body onLoad="czas()">
	<div id="naglowek_INFO"><a href="/moj/index.php"><p>Poradnik Marvel Future Fight</p></a></div>
	<div id="witaj">
<?php
...
?>	
	...
	<div class="kolumna_srodkowa">
			...
			<div class="panel_tresc">
					<p class="naglowek_srodkowy">Podstawowe informacje o ABX</p>
					<p class="tresc">
<b>Czym jest rotacja?</b><br><br>
Rotacja nazywamy ciag naciskanych przycisków (skilli) aby postać na miarę
możliwosci nie umierała/biła jak najwięcej i była schowana w iframe*.<br>
Przykładowa rotacja:<br>
<li>4c3c25(obel)</li><br>
<b>C</b> w rotacji oznacza "cancel", czyli w przypadku powyżej rotacji robimy szybkie
naciskanie przyciskami 4->3->2. Zwinne paluszki, można powiedzieć. Jeżeli w
rotacji zas nie ma "C", oznacza to, że czekamy do wykończenia skilla. Czyli w
powyższym przykładzie wyglada to tak:<br>
<li>4 szybki klik na 3, szybki klik na 2, czekamy aż skill 2 się skończy, 5 (obel).</li><br>
Obel oznacza, że wraz z nacisnięciem tego skilla, obelisk powinien się odpalić. To
zdecydowanie najtrudniejsza częsć rotacji. Każda postać ma swoje unikalne 
skille, o różnym trwaniu czasowym. A co za tym idzie, musimy zrozumieć ich
gameplay, aby zawsze trafiać obeliskiem na dany skill, a nie inny. To, kiedy
obelisk jest odpalony zauważymy przy awatarze postaci (zielona, nazwijmy,
dioda) badz nad postacia wyskoczy napis, że Obelisk jest odpalony.<br>
<b>Potrzebne obeliski, bonusy i karty?</b><br>
Jak nazwa wskazuje, tak jak i w AC potrzebujemy głównie debuffa, tak na ABX
potrzebujemy konkretnych bonusów. Jesli chodzi o obeliski, sa to głównie te,
które maja % per attack. Najkorzystniej byłoby rzucić oczywiscie CTP of Energy,
ale jako że NM jest baaaardzo dla nas kochane, to możemy żyć nadzieja, że to
w przyszłym roku będzie dla nas dopiero wykonalne. :D 200% per attack to
największa możliwosć. Nie warto dawać zas 120, 140 czy i 160. To będzie
ledwo zauważalne. Dopiero od 180 wzwyż jest to siła.<br><br>
Bonusy na ABX które sa totalnie niezbędne to Reduce Cooldown Duration oraz
Ignore Defense. Jeżeli ktos naprawdę chce się bawić w tym trybie, postać która
chce bić jakies wyniki, musi mieć te dwa bonusy zmaxowane, toteż na 50 %.
Bez tego ani rusz. Jesli postać ma zrobiony cooldown na maxa, automatycznie
rotacja będzie działała niemalże za każdym razem, gdy chociaż raz już ja
ogarniemy.<br><br>
Karty sa zdecydowanie największym problemem tutaj. Rollowanie ich to dobre
kilka miesięcy, a nawet i w przypadku niektórych lat, pracy. Tutaj polecam z
całego serca pójsć w kierunku takich, co maja owe powyższe bony, ALE również
All attack/Energy Attack czy Physical Attack. Takie rzeczy przydadza się nam
również na WBU czy AC.<br><br>
<b>Buffery sa niezbędne do robienia rekordów. </b><br>
Zostało wprowadzone kilka postaci, które mają na t2 pasywkę, która daje % przeciwko Super Villain.
Postacie te głównie sa płatne (ponieważ jak wyżej wspominałem, NM jest
mega kochane <3)
Postacie niezbędne do buffów to:
<li>White Fox (Jest póki co chyba najlepsza)</li>
<li>Coulson</li>
<li>Valkyrie</li>
<li>Ghost Panther</li>
<li>Shuri</li>
...
<li>Victorious</li>
<li>Nick Fury</li><br>
Warto dodać, że sa potrzebne również postacie z dobrymi liderkami, jak np.
She Hulk, Beast/Titania, Antiman, Magneto, znowu Fury, Hyperion (tak, tylko
do tego się nadaje xD), Victorious
<br><br>
Teamy będę zapisywane w formie:<br>
<b>Leader/ postać która bijemy/ Buffer</b>
					</p>
